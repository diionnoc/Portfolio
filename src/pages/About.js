    ...
    <section id="about">
      <div className="about">
        ...
        <p className="about-body">
          Hello, my name is Chelsea and I am an artist from Lincoln University, PA! I graduated from Longwood University in 2017 with a degree in Graphic and
          Animation Design. I am currently working as a freelance artist, actively searching for a career in the animation industry as a character designer or
